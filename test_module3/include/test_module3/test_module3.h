...
class TestModule3 : public robotis_framework::MotionModule, public robotis_framework::Singleton<TestModule3>
{
public:
  TestModule3();
  virtual ~TestModule3();
...
private:
  ...
  // for sensor value 
  double rl_gyro_err; // right and left
  double fb_gyro_err; // forward and backward

  Eigen::Matrix3d current_orientation_, previous_orientation_;
};
}
